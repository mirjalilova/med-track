...
func (c *lifestyleServiceClient) Get(ctx context.Context, in *GetById, opts ...grpc.CallOption) (*LifestyleRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LifestyleRes)
...
func (c *lifestyleServiceClient) List(ctx context.Context, in *GetAllLifestyleReq, opts ...grpc.CallOption) (*GetAllLifestyleRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetAllLifestyleRes)
...
func (UnimplementedLifestyleServiceServer) Get(context.Context, *GetById) (*LifestyleRes, error) {
...
func _LifestyleService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LifestyleServiceServer).List(ctx, req.(*GetAllLifestyleReq))
	}
	return interceptor(ctx, in, info, handler)
}
